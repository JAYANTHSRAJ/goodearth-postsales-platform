      ...
      <div className="flex items-center gap-3">
        ...
        {currentStep === totalSteps && isLocked ? (
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-bold text-white bg-brand-900 hover:bg-brand-800 shadow-md transition-all duration-200"
          >
            Back to Dashboard
          </button>
        ) : (
          <button
            ...
            disabled={isSubmitting || (currentStep === totalSteps && !canSubmit)}
