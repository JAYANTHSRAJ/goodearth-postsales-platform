...
export const KycInputField: React.FC<KycInputFieldProps> = ({
  ...
  return (
    <div className="w-full space-y-1">
      <label htmlFor={inputId} className="block text-[11px] font-semibold text-slate-700 dark:text-slate-300">
      ...
      <input
        ...
        className={`w-full px-3 py-1.5 rounded-lg border text-sm transition-all focus:outline-none focus:ring-2 ${
          error
