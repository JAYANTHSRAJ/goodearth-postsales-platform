...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`rounded-3xl border border-brand-200/80 bg-white p-6 shadow-sm dark:border-brand-800 dark:bg-brand-900 transition-all duration-300 hover:shadow-md ${className}`}
    >
