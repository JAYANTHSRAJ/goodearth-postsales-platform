...
public class KycApplicationMapper {
    ...
    public KycApplicationResponseDto toResponseDto(KycApplication application, List<Document> documents) {
        ...
        return KycApplicationResponseDto.builder()
                ...
                .zohoSyncStatus(application.getZohoSyncStatus() != null ? application.getZohoSyncStatus() : "SUCCESS")
                .zohoLastSyncedAt(application.getZohoLastSyncedAt() != null ? application.getZohoLastSyncedAt() : application.getUpdatedAt())
                .zohoSyncError(application.getZohoSyncError())
                .zohoDealRecordId(application.getZohoDealRecordId())
