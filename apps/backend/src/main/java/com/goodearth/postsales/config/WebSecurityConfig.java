    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> {
                auth.requestMatchers("/actuator/**", "/health", "/api/v1/health", "/api/v1/admin/verification/**", "/admin/verification/**", "/verification/**", "/api/v1/kyc/documents/*/file", "/api/v1/kyc/documents/**/file").permitAll()
                    .requestMatchers(
